# QUIZ SECTION: Strings Quiz Section
...
# the time of their visit and the site they accessed. You should use the variables provided and 
# the techniques you’ve learned to print a log message like this one (with the username, url, 
...
access = "accessed the site" 
at = "at" 
print(username + " " + access + " " + url + " " + at + " " + timestamp)
